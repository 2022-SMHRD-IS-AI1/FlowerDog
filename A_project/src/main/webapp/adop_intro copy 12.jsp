        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="./Boardcss/image/a12.png" alt="..." /></div>
                    <div class="col-md-6 " >
                        <span><img src="./Boardcss/image/b12.png" alt=""></span>
                        <br>
                    ...
                    <div class="fs-5 mb-5">
                        ...
                        <div class="intro">
                        <p class="lead">[마중]를 소개합니다!<br>

                            [마중]를 사랑으로 보듬어 줄 수 있는<br>
