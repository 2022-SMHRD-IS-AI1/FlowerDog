...
<html>
	<head>
		...
		<!-- Styles -->
		<!-- Bootstrap CSS -->
		<link href="css/bootstrapMK.min.css" rel="stylesheet">
		<!-- Font awesome CSS -->
		<link href="css/font-awesomeMK.min.css" rel="stylesheet">		
		<!-- Custom CSS -->
		<link href="css/styleMK.css" rel="stylesheet">
				...
				<nav class="navbar navbar-default" role="navigation">
					...
					<div class="container">
						...
						<div class="navbar-header">
							<a class="navbar-brand" href="#"><img class="img-responsive" src="./img/log.png" alt="Logo"/></a>	
