        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="./Boardcss/image/a10.png" alt="..." /></div>
                    <div class="col-md-6 " >
                        <span><img src="./Boardcss/image/b10.png" alt=""></span>
                        <br>
                    ...
                    <div class="fs-5 mb-5">
                        ...
                        <div class="intro">
                        <p class="lead">[함박]를 소개합니다!<br>

                            [함박]를 사랑으로 보듬어 줄 수 있는<br>
                            
                            새로운 가족을 찾습니다.</p>
                        </div>
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <br>
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="adopting.jsp"> 입양신청하기</a> <a class="btn btn-outline-dark mt-auto" href="./adop_guide.jsp">입양 절차 및 책임비 가이드 보기</a></div>
