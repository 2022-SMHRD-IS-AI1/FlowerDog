...
<body>
				...
				<div class="container">
					...
					<div class="navbar-header" style="display: inline;">
						<a class="navbar-brand" href="main.jsp"><img
							class="img-responsive" src="./Boardcss/image/logo.png" alt="Logo"
	...
	<div id="board">
		...
		<form action="Board_Creating" method="post" >
			<div id="list">
				...
				<div>
					<textarea name="writer" rows="1"cols="60" style="font-size: 20px;" maxlength="100"><%=id%></textarea>
				</div>
	...
	<footer style="margin-top: 30px;">
		<div class="container-footer">
			<p>
				<a href="main.jsp">Home</a> | <a href="product_list.jsp">Product</a>
				| <a href="adop_list.jsp">Adoption</a> | <a href="noticeboard.jsp">Sharing</a>
			</p>
			<div class="social">
			...
			<p class="copy-right">
				inception &FlowerDog; 2023 <a href="#홈페이지소개">Your Site</a> | Team
				Member : <a href="#홈페이지소개">Flower Dog</a>, Have a happy day.
			</p>
		</div>
	</footer>
